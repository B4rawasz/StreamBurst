...
import { CollapsibleControl, LayoutBody, Navbar, NavbarSidebarTrigger } from "./docs-client";
import { TreeContextProvider } from "fumadocs-ui/contexts/tree";
import { ThemeToggle } from "../layout/theme-toggle";
import { getSidebarTabsFromOptions, SidebarLinkItem, type SidebarOptions } from "./docs/shared";
				...
				<HideIfEmpty>
					<SidebarHeader className="data-[empty=true]:hidden">
						...
						{searchToggle.enabled !== false &&
							(searchToggle.components?.lg ?? <LargeSearchToggle hideIfDisabled className="max-md:hidden" />)}
	...
	return (
		<TreeContextProvider tree={props.tree}>
			<NavProvider transparentMode={transparentMode}>
				...
				<LayoutBody {...props.containerProps} className={cn(variables, props.containerProps?.className)}>
